...
print("Baseline (opciones_combate, 100,000 iterations):", timeit.timeit(test_combate, setup=setup_code_juego, number=100000))
print("Baseline (opciones_juego, 100,000 iterations):", timeit.timeit(test_juego, setup=setup_code_juego, number=100000))
